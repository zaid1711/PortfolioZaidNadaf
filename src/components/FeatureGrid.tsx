...
const skills = [
  ...
  { icon: Server, title: "Backend Development", desc: "Python, Django for building scalable APIs and robust server-side applications." },
    ...
    <section id="skills" className="bg-yellow py-16 sm:py-24 border-y-2 border-foreground relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-12">
        <motion.h2 
          ...
          className="font-cabinet font-extrabold text-2xl sm:text-4xl md:text-5xl tracking-tighter text-center mb-3 sm:mb-4"
        >
          My Core Skills
        </motion.h2>
        <motion.p 
          ...
          className="font-satoshi text-base sm:text-lg text-center opacity-70 mb-12 sm:mb-16 max-w-xl mx-auto"
        >
        ...
        >
          {skills.map((skill, i) => (
            <motion.div variants={itemVariants} key={i} className="group bg-card p-6 sm:p-8 border-2 border-foreground rounded-xl shadow-brutal-sm hover:shadow-brutal-md hover:-translate-y-1 transition-all duration-200">
              <div className="w-12 sm:w-14 h-12 sm:h-14 bg-sage rounded-lg border-2 border-foreground flex items-center justify-center mb-4 sm:mb-6 group-hover:bg-yellow transition-colors group-hover:scale-110">
