...
const Navbar = () => {
  return (
    <motion.nav 
      ...
      className="fixed top-0 left-0 right-0 z-50 h-16 sm:h-20 bg-yellow border-b-2 border-foreground flex items-center px-4 sm:px-6 lg:px-12"
    >
      ...
      <div className="hidden md:flex items-center gap-4 lg:gap-8 mx-auto font-satoshi font-bold text-xs sm:text-sm">
        <a href="#skills" className="hover:underline underline-offset-4 hover:text-foreground/70 transition-colors">Skills</a>
        <a href="#projects" className="hover:underline underline-offset-4 hover:text-foreground/70 transition-colors">Projects</a>
        <a href="#experience" className="hover:underline underline-offset-4 hover:text-foreground/70 transition-colors">Experience</a>
        <a href="#contact" className="hover:underline underline-offset-4 hover:text-foreground/70 transition-colors">Contact</a>
      </div>
