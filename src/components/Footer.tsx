            ...
            <div className="flex gap-2 sm:gap-3 mt-4 sm:mt-6">
              {[
                ...
                <a
                  ...
                  className="w-8 sm:w-10 h-8 sm:h-10 bg-[#272727] border border-sage/20 rounded-sm flex items-center justify-center text-sage/60 text-xs font-satoshi font-bold hover:bg-yellow hover:text-foreground hover:border-foreground transition-colors cursor-pointer"
                >
                  {s.label}
                </a>
              ))}
                ...
                {links.map((link) => (
                  <li key={link.label}>
                    <a
                      ...
                      className="font-satoshi text-xs sm:text-sm text-sage/50 hover:text-yellow transition-colors"
                    >
                      {link.label}
                    </a>
                  </li>
